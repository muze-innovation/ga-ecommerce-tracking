...
export class GA4 implements BaseProvider {
  ...
  public send(action: Action, data: ActionData) {
    if (window.gtag !== undefined) {
      this.debug && console.log('send (GA4)', action, data);
      switch (action) {
        case 'view_item':
        ...
        case 'add_payment_info':
          ...
          this.debug && console.log('add_payment_info', paymentInfoAction);
        ...
        case 'add_shipping_info':
          ...
          this.debug && console.log('add_shipping_info', shippingInfoAction);
